...
function Hero() {
    return (
        ...
        style={{
        backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 1) 100%), url(${import.meta.env.BASE_URL}pictures/aboutpagehero.png)`, 
        ...
        backgroundBlendMode: "overlay"
            ...
            <div className="hero-text-container">
                <h1 className="project-title"><a href="https://github.com/MahdeeK/Portfolio-website" target="_blank">Portfolio</a></h1>
            ...
            >
                <div className="summary-text">
                    ...
                    <div className="solution-statement-container" style={{marginBottom: "48px"}}>
                        ...
                        <p className="summary-text">
                            I developed a portfolio site that serves as a central narrative hub. By stripping away visual noise 
                            and focusing on a minimalist aesthetic with a native dark-mode theme, I created a platform that guides users through 
                            my work while providing clear context on my value proposition and technical expertise.
                        </p>
                    </div>
                    <p className="motivation-text">
                        This project was an exercise in product storytelling. I wanted to prove that I could take complex multi-faceted projects and 
                        distill them into high-impact case studies that tell a story from "problem to solution" without overwhelming the reader. Additionally,
                        I wanted to show that I can communicate my personal brand in an effective and narrative driven manner, making it more engaging for 
                        users to get to know me.
                    </p>
                </div>
                <div className="key-stats">
                    <ul>
                        ...
                        <li className="summary-list-item">
                            ...
                            <p style={{margin: "0px"}}><a className="summary-links" href="https://github.com/MahdeeK/Portfolio-website" target="_blank">GitHub Repository</a></p>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    return (
        <section className="content-container">
            ...
            <p className="research-intro">
                To define a high-impact professional presence, I audited industry-leading portfolios to identify the 
                common denominators of successful storytelling. My research focused on balancing what hiring managers 
                recommend, structured and results-oriented narratives, with a dark mode aesthetic that is commonly seen in 
                high-end design brands. I found that the most effective sites avoid over-designing the container, 
                instead using minimalist UI and strong typography to let the work take center stage. I took inspiration 
                from these sites, shown in the gallery below, to create a layout that feels premium yet remains highly functional.
            </p>
                ...
                <div className="two-column-grid">
                    <ul className="bulleted-list">
                        <li className="bullet-points">
                            <span className="bullet-heading">The "Zero-Clutter" Hero:</span> I opted for a minimal hero section featuring only my name, value proposition, and navigation. This eliminates distractions and ensures the user’s first impression is focused entirely on who I am and what I can do for them.
                        </li>
                        <li className="bullet-points">
                            <span className="bullet-heading">Structured Case Study Narrative:</span> To keep readers engaged, I structured projects to follow a high-level to deep-dive flow. Starting with a summary and key stats allows users to skim to get the value immediately, while the research and design sections satisfy those looking for extra detail.
                        </li>
                        <li className="bullet-points" style={{marginBottom: "0px"}}>
                            <span className="bullet-heading">Unified Contacts:</span> I integrated GitHub, LinkedIn, my Resume, and email into a persistent footer and navbar. This transformed the site from a simple gallery into a functional tool for recruiters to transition from my work to my professional history or contact information.
                        </li>
                    </ul>
                    <ul className="bulleted-list">
                        <li className="bullet-points">
                            <span className="bullet-heading">Personality Integration:</span> I included a short about section that blends technical skills with my personality and hobbies. This humanizes the experience by showing the person behind the build and the specific goals and pursuits being worked towards.
                        </li>
                        <li className="bullet-points">
                            <span className="bullet-heading">Content Sprints:</span> I intentionally kept the case studies short and high-impact. By focusing on short captions and bullet points rather than long paragraphs, I ensured the portfolio respects the user's time while still proving my design logic.
                        </li>
                        <li className="bullet-points">
                            <span className="bullet-heading">Motion-Enhanced Discovery:</span> To add a sense of polish and flair, I used Framer Motion to create subtle animations and micro-interactions throughout the site. This guides the user's attention and makes the site feel reactive, premium, and modern.
                        </li>
                    </ul>
                </div>
            </div>
    ...
    return (
        <section className="content-container">
            ...
            >
                    ...
                    <motion.img src={`${import.meta.env.BASE_URL}pictures/projectsummarywireframe.png`} alt="Project Summary Section Wireframe" variants={item} style={{padding: "4px", backgroundColor: "#222222", borderRadius: "8px"}}/>
            </motion.div>
        </section>
    )
}
                ...
                <div className="design-item">
                    ...
                    >
                        ...
                        <p className="design-item-text">
                            ...
                            project and allow users to process each one. I also used a backdrop to create contrast with the background to ensure the images don't blend
                            in and make it difficult for the user to process. For each project, I used a title to convey the overarching work that was done while the subtitles specify the exact type of 
                ...
                <div className="design-item flipped-design">
                    ...
                    >
                        ...
                        <p className="design-item-text">
                            ...
                            images of different games that I enjoy and creating a non-standard layout with no text and the rotated image. The image gives insight into
                ...
                <div className="design-item flipped-design">
                    ...
                    >
                        ...
                        <p className="design-item-text">
                            ...
                            time from the perspective of a hiring manager while providing sufficient details for them to understand my work and skills from my perspective.
                        </p>
                    </motion.div>
                    <motion.img 
                    className="design-image" 
        ...
        <section className="content-container">
            ...
            <div className="text-content-wrapper">
                <div className="development-text">
                    <p>
                        I built the entire portfolio from scratch using React and Vite, focusing on creating a 
                        performance-oriented architecture that could handle project assets while maintaining a cinematic, 
                        high-end feel through motion and imagery.
                    </p>
                    <div className="implementation-highlights">
                        ...
                        <ul className="bulleted-list">
                                ...
                                <li className="bullet-points">
                                    <span className="bullet-heading">Native Dark Mode Architecture:</span> I built the site with a persistent dark-mode foundation, ensuring that high-contrast project assets and typography remain the focal point while reducing eye strain for long-form reading.
                                </li>
                                <li className="bullet-points">
                    ...
                    <div className="technical-challenges">
                        ...
                        <ul className="bulleted-list">
                                ...
                                <li className="bullet-points">
                                    <span className="bullet-heading">Deployment: </span> Hosting a React-based project on GitHub Pages required careful configuration of client-side routing and asset paths to ensure the live environment perfectly matched my local development build.
                                </li>
                                <li className="bullet-points">
    ...
    return (
        ...
        >
            ...
            <p className="conclusion-intro">
                The portfolio site successfully bridges the gap between my technical skills and my personal brand. 
                By centralizing my work, I have created a one-stop-shop for anyone wanting to understand me and my 
                design process, effectively turning my disjointed project links and contacts into a professional 
                career story.
            </p>
            <div className="growth-container">
                ...
                <div className="two-column-grid">
                    <ul className="bulleted-list">
                        ...
                        <li className="bullet-points" style={{marginBottom: "0px"}}>
                            <span className="bullet-heading">Narrative Design:</span> This project forced me to act as my own editor by learning how to trim down case studies to their most impactful points to avoid fatiguing the reader.
                        </li>
                    </ul>
                    <ul className="bulleted-list">
                        <li className="bullet-points">
                            <span className="bullet-heading">Self-Branding:</span> I gained experience in defining my own value proposition by learning how to communicate my worth to a potential employer in a single sentence.
                        </li>
                        <li className="bullet-points">
                            <span className="bullet-heading">User Flow Optimization:</span> Designing mainly for recruiters taught me to put the most important information (projects and resume) in the most accessible places.
                        </li>
                    </ul>
                </div>
            </div>
            <div className="next-steps-container">
                ...
                <div className="two-column-grid">
                    <ul className="bulleted-list">
                        ...
                        <li className="bullet-points" style={{marginBottom: "0px"}}>
                            <span className="bullet-heading">SEO & Discoverability:</span> I would implement a solid SEO strategy, including optimized meta-tags for each case study, structured data (JSON-LD) to help search engines understand my role, and keyword-rich descriptions to increase organic visibility to recruiters.
                        </li>
                    </ul>
                    <ul className="bulleted-list">
                        <li className="bullet-points">
                            <span className="bullet-heading">Asset Optimization:</span> To maintain the cinematic feel without sacrificing speed, I would implement asset-loading strategies like lazy-loading for images and WebP conversion to ensure sub-second time to interactive across all devices.
                        </li>
                        <li className="bullet-points">
                            <span className="bullet-heading">Accessibility & Inclusion:</span> To ensure the site is usable for everyone, I would conduct a full accessibility audit to reach WCAG standards. This includes ensuring 100% keyboard navigability, adding descriptive ARIA labels for screen readers, and verifying that the dark-mode color palette maintains high contrast ratios.
                        </li>
                    </ul>
                </div>
            </div>
            <p className="bottom-line"><span className="bullet-heading">The Bottom Line:</span> This project reinforced the importance of design as a narrative as it proved that a well-structured digital experience is the most effective tool to transform a collection of separate items into a high-impact career story.</p>
        </motion.section>
    )
}